...
func (s *TaobaoXhotelRoomsIncrementRequest) SetRoomQuotaMap(v string) *TaobaoXhotelRoomsIncrementRequest {
    s.RoomQuotaMap = &v
    return s
}

func (req *TaobaoXhotelRoomsIncrementRequest) ToMap() map[string]interface{} {
...
func (req *TaobaoXhotelRoomsIncrementRequest) ToFileMap() map[string]interface{} {
