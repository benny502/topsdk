...
func (s *TaobaoXhotelMultipleratesUpdateRequest) SetRateQuotaMap(v string) *TaobaoXhotelMultipleratesUpdateRequest {
    s.RateQuotaMap = &v
    return s
}

func (req *TaobaoXhotelMultipleratesUpdateRequest) ToMap() map[string]interface{} {
...
func (req *TaobaoXhotelMultipleratesUpdateRequest) ToFileMap() map[string]interface{} {
