...
func (s *TaobaoXhotelRatesUpdateRequest) SetRateInventoryPriceMap(v string) *TaobaoXhotelRatesUpdateRequest {
    s.RateInventoryPriceMap = &v
    return s
}

func (req *TaobaoXhotelRatesUpdateRequest) ToMap() map[string]interface{} {
...
func (req *TaobaoXhotelRatesUpdateRequest) ToFileMap() map[string]interface{} {
